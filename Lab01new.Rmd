...
# Objectives: use basic commands, create object, use function, simple statistics plotting object
# Basic Commands
...
x=rnorm(100)
y=rnorm(100)
plot(x,y, pch=20, col="blue", cex=1.5) # Scatterplot for two numeric variables by default
